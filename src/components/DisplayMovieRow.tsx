...
>
  {movie.genre_ids == "[1]" && (
    <img
      ...
      style={{ width: '25vw', height: '25vh' }} // Utiliser 50% de la largeur et de la hauteur de la fenêtre d'affichage
    />
  )}
  {movie.genre_ids == "[2]" && (
    <img
  ...
  {movie.genre_ids == "[3]" && (
    <img
      src={'https://source.unsplash.com/featured/?horse'}
      className='movieShowcase__container--movie-image'
      style={{ width: '25vw', height: '25vh' }} // Utiliser 50% de la largeur et de la hauteur de la fenêtre d'affichage
    />
  )}
  {movie.genre_ids == "[4]" && (
    <img
      src={'https://source.unsplash.com/featured/?rabbit'}
      className='movieShowcase__container--movie-image'
      style={{ width: '25vw', height: '25vh' }} // Utiliser 50% de la largeur et de la hauteur de la fenêtre d'affichage
    />
  )}
  {movie.genre_ids == "[5]" && (
    <img
      src={'https://source.unsplash.com/featured/?rodent'}
      className='movieShowcase__container--movie-image'
      style={{ width: '25vw', height: '25vh' }} // Utiliser 50% de la largeur et de la hauteur de la fenêtre d'affichage
    />
  )}
